# Full-Stack MERN e-commerce application project 


### landing page
![Landing page](https://github.com/Chiranjibichapagain/fast-track-5-typescript-men-boilerplate/blob/develop/client/src/ASSETS/screenshots/landing%20_page.png)

### Cart page
![Landing page](https://github.com/Chiranjibichapagain/fast-track-5-typescript-men-boilerplate/blob/develop/client/src/ASSETS/screenshots/cart.png)

### AdminDasboard-Product
![Landing page](https://github.com/Chiranjibichapagain/fast-track-5-typescript-men-boilerplate/blob/develop/client/src/ASSETS/screenshots/Admin_product_view.png)

### AdminDasboard-Product
![Landing page](https://github.com/Chiranjibichapagain/fast-track-5-typescript-men-boilerplate/blob/develop/client/src/ASSETS/screenshots/Admin_user_view.png)

### Login page
![Landing page](https://github.com/Chiranjibichapagain/fast-track-5-typescript-men-boilerplate/blob/develop/client/src/ASSETS/screenshots/login.png)
